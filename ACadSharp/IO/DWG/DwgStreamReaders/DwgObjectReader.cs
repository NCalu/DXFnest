...
namespace ACadSharp.IO.DWG
{
	...
	internal partial class DwgObjectReader : DwgSectionIO
	{
		...
		private CadTemplate readPdfUnderlay()
		{
			...
			CadUnderlayTemplate<PdfUnderlayDefinition> template = new CadUnderlayTemplate<PdfUnderlayDefinition>(underlay);
		...
		private CadTemplate readDbColor()
		{
			...
			CadNonGraphicalObjectTemplate template = new CadNonGraphicalObjectTemplate(bookColor);
