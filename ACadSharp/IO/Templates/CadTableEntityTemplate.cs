...
namespace ACadSharp.IO.Templates
{
	...
	internal class CadTableEntityTemplate : CadInsertTemplate
	{
		...
		private readonly List<CadTableCellTemplate> _cadTableCellTemplates = new List<CadTableCellTemplate>();
		...
		{
			public List<Tuple<CellBorder, ulong>> BorderLinetypePairs { get; set; } = new List<Tuple<CellBorder, ulong>>();
